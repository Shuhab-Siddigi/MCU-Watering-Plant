...
#define FLOATSWITCH_SetDigitalInput()(_TRISA8 = 1)
#define FLOATSWITCH_GetValue()         _RA8

#define LED_SetDigitalOutput() (_TRISA10 = 0)
#define LED_SetLow()           (_LATA10 = 0)
#define LED_SetHigh()          (_LATA10 = 1)
